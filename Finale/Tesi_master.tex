...
%\definecolor{ocra}{rgb}{0.204, 0.119, 0.34}218-165-32
\definecolor{ocra}{RGB}{218,165,32}
\definecolor{maroon}{rgb}{0.5,0,0}
\definecolor{darkgreen}{rgb}{0,0.5,0}
%\definecolor{indianred}{RGB}{205,92,92}165-42-42
...
The produced schedule in shown in code \ref{scheduletest}.
...
<Schedule>
  ...
  <Pragma>
    ...
    <Start_time>0</Start_time>
    <Deadline>19963.5056647</Deadline>
    <Barrier>
      <id>87</id>
    </Barrier>
  </Pragma>
  ...
  <Pragma>
    ...
    <Start_time>19963.5056647</Start_time>
    <Deadline>19999.9878313</Deadline>
  </Pragma>
  <Pragma>
    <id>167</id>
    ...
    <Start_time>19999.9878313</Start_time>
    <Deadline>19999.9878313</Deadline>
    <Barrier>
      <id>169</id>
    </Barrier>
  ...
  <Pragma>
    ...
    <Start_time>19963.5056647</Start_time>
    <Deadline>19999.9656647</Deadline>
  </Pragma>
  <Pragma>
    <id>150</id>
    <Caller_id>118</Caller_id>
    <Type>dx</Type>
    <Threads>
      <Thread>0</Thread>
    </Threads>
    <Start_time>19999.9656647</Start_time>
    <Deadline>19999.9658092</Deadline>
    <Barrier>
      <id>152</id>
    </Barrier>
  </Pragma>
  <Pragma>
    ...
    <Start_time>19999.9658092</Start_time>
    <Deadline>20000.0</Deadline>
    <Barrier>
      <id>152</id>
    </Barrier>
...
The first test simply analyzed the completion time of the sequential program, the OpenMP version and the program rewritten using the framework. As seen from graph \ref{timegraph} and table \ref{timetable} the framework achieves the same statistics as OpenMP having an almost one scaling factor.
...
The different service times for each thread have been analyzed in each of the three different video qualities. The results are shown in the relative tables. A boxplot has been created to show the statistics of the service time of each thread. 
...
The following graphs compare the jitter and time difference between the single cores' service time in the current framework and OpenMP.

\begin{figure}[H]
\centering
\includegraphics[scale=0.3]{omp_480_range_010.png}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.3]{soma_480_range_010.png}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.3]{omp_720_range_050.png}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.3]{soma_720_range_050.png}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.3]{omp_1080_range_040.png}
\caption{Service time of each core in a 0-40s interval at 1080p (OpenMP).}
\label{omp1080jitter}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[scale=0.3]{soma_1080_range_040.png}
\caption{Service time of each core in a 0-40s interval at 1080p (Soma).}
